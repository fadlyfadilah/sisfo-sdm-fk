...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("frontend.diklats.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_diklat') ? 'is-invalid' : '' }}" name="jenis_diklat" id="jenis_diklat">
                    ...
                    @foreach(App\Models\Diklat::JENIS_DIKLAT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('jenis_diklat', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('kategori_keg') ? 'is-invalid' : '' }}" name="kategori_keg" id="kategori_keg">
                    ...
                    @foreach(App\Models\Diklat::KATEGORI_KEG_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('kategori_keg', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_diklat') ? 'is-invalid' : '' }}" type="text" name="nama_diklat" id="nama_diklat" value="{{ old('nama_diklat', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tingkatan_diklat') ? 'is-invalid' : '' }}" name="tingkatan_diklat" id="tingkatan_diklat">
                    ...
                    @foreach(App\Models\Diklat::TINGKATAN_DIKLAT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tingkatan_diklat', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.diklat.fields.tingkatan_diklat_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="tahun_diklat">Tahun Diklat</label>
                <input class="form-control {{ $errors->has('tahun_diklat') ? 'is-invalid' : '' }}" type="text" name="tahun_diklat" id="tahun_diklat" value="{{ old('tahun_diklat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peran') ? 'is-invalid' : '' }}" type="text" name="peran" id="peran" value="{{ old('peran', '') }}">
                @if($errors->has('peran'))
                    <div class="invalid-feedback">
                        {{ $errors->first('peran') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_jam') ? 'is-invalid' : '' }}" type="text" name="jumlah_jam" id="jumlah_jam" value="{{ old('jumlah_jam', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tgl_sk') ? 'is-invalid' : '' }}" type="text" name="tgl_sk" id="tgl_sk" value="{{ old('tgl_sk', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control-file {{ $errors->has('file_diklat') ? 'is-invalid' : '' }}" type="file" name="file_diklat" id="file_diklat" value="{{ old('file_diklat', '') }}">
