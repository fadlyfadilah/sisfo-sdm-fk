...
@can('peningkatan_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-6">
            <a class="btn btn-success" href="{{ route('admin.peningkatans.create') }}">
        ...
        <div class="col-lg-6">
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="/admin/export/peningkatan">Data Peningkatan kompetensi Dosen</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <tr data-entry-id="{{ $peningkatan->id }}">
                            ...
                            <td>
                                @can('peningkatan_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.peningkatans.show', $peningkatan->id) }}">
                                        View
                                    </a>
                                @endcan

                                @can('peningkatan_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.peningkatans.edit', $peningkatan->id) }}">
                                       Edit
                                    </a>
                                @endcan

                                @can('peningkatan_delete')
                                    <form action="{{ route('admin.peningkatans.destroy', $peningkatan->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
